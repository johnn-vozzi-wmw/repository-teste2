...
public class GetPontuacaoRealizadaItemTest {

	public PontuacaoConfigService service;

	public GetPontuacaoRealizadaItemTest() {
	...
	public void deveRetornarZeroQuandoParametrosNulos() throws SQLException {
		assertEquals(0d, service.getPontuacaoRealizadaItem(null, null));
	}

	@Test
	public void deveRetornarZeroQuandoItemPedidoNulo() throws SQLException {
		assertEquals(0d, service.getPontuacaoRealizadaItem(null, new PontuacaoConfig()));
	}
	...
	public void deveRetornarZeroQuandoPontuacaoConfigNula() throws SQLException {
		...
		assertEquals(0d, service.getPontuacaoRealizadaItem(itemPedido, null));
	}
	...
	public void deveRetornarUmQuandoPontuacaoProdutoNula() throws SQLException {
		...
		assertEquals(1d, service.getPontuacaoRealizadaItem(itemPedido, pontuacaoConfig));
	}
	...
	public void deveMultiplicarQuantidadePorPesoInteiro() throws SQLException {
		...
		assertEquals(120d, service.getPontuacaoRealizadaItem(itemPedido, pontuacaoConfig));
	}
	...
	public void deveMultiplicarQuantidadePorPesoFracionado() throws SQLException {
		...
		pontuacaoConfig.pontuacaoFaixaPreco.vlFatorCorrecao = 1.33333;
		pontuacaoConfig.pontuacaoFaixaDiaCondicaoPagto.vlFatorCorrecao = 1.33333;
		assertEquals(17.76, service.getPontuacaoRealizadaItem(itemPedido, pontuacaoConfig));
	}
