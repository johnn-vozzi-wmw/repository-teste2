...
public class EstoquePrevisto extends BaseDomain {
	
	public static String TABLE_NAME = "TBLVPESTOQUEPREVISTO";
    ...
    public EstoquePrevisto(String cdEmpresa, String cdRepresentante, String cdProduto, Date dtEntrega) {
    ...
    public EstoquePrevisto(String cdEmpresa, String cdRepresentante, String cdProduto) {
		this.cdEmpresa = cdEmpresa;
		this.cdRepresentante = cdRepresentante;
		this.cdProduto = cdProduto;
	}
    ...
    public boolean equals(Object obj) {
        if (obj instanceof EstoquePrevisto) {
            EstoquePrevisto estoquePrevisto = (EstoquePrevisto) obj;
            return
                ValueUtil.valueEquals(cdEmpresa, estoquePrevisto.cdEmpresa) && 
                ValueUtil.valueEquals(cdRepresentante, estoquePrevisto.cdRepresentante) && 
